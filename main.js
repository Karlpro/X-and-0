...
// 0
	if(allblock[0].innerHTML == '0' && allblock[1].innerHTML=='0' && allblock[2].innerHTML=='0') alert("0 Winner");
	if(allblock[3].innerHTML == '0' && allblock[4].innerHTML=='0' && allblock[5].innerHTML=='0') alert("0 Winner");
	if(allblock[6].innerHTML == '0' && allblock[7].innerHTML=='0' && allblock[8].innerHTML=='0') alert("0 Winner");
	if(allblock[0].innerHTML == '0' && allblock[3].innerHTML=='0' && allblock[6].innerHTML=='0') alert("0 Winner");
	if(allblock[1].innerHTML == '0' && allblock[4].innerHTML=='0' && allblock[7].innerHTML=='0') alert("0 Winner");
	if(allblock[0].innerHTML == '0' && allblock[4].innerHTML=='0' && allblock[8].innerHTML=='0') alert("0 Winner");
	if(allblock[2].innerHTML == '0' && allblock[4].innerHTML=='0' && allblock[6].innerHTML=='0') alert("0 Winner");
}
}